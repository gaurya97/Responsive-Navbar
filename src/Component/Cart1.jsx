...
export const Cart1 = () => {
  return (
    <div >
  <div className="md:max-w-60  max-w-72 mx-auto my-6 bg-white rounded-lg shadow-lg overflow-hidden">

<div className="relative">
    <img src="https://via.placeholder.com/400x300" className="w-full h-48 object-cover" alt="Food Image" />
